...
\resheading{Skills}
	\begin{itemize}
		...
		\resitem{\textbf{Frameworks/Technologies}: React, Redux, Ruby on Rails, AWS (EC2, S3, CodePipeline), MongoDB, ElasticSearch, Protocol Buffers, BigTable, Spanner, MapReduce, Flume}
